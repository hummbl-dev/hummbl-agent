...
- Technical obstacles that seem insurmountable
- Cross-functional coordination challenges
- Strategic decision-making scenarios

## How to Apply
1. Identify current perspective and assumptions
2. Generate at least 4 alternative viewpoints
3. Look for patterns and conflicts across views
4. Synthesize insights into reframed problem
5. Validate with relevant stakeholders

---
*Base120 P1 transformation creates comprehensive problem understanding*
