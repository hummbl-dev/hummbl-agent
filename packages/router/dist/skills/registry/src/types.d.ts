...
export type SkillKind = "primitive_transformation" | "integration_pattern" | "model_binding";
export type TransformationCode = "T.PER" | "T.INV" | "T.COM" | "T.DEC" | "T.REC" | "T.SYS" | "T.INT";
export type RunnerId = string;
export declare const RECOMMENDED_RUNNERS: readonly ["claude-code", "codex", "grok", "local-cli", "template"];
export type SkillIO = {
    name: string;
    type: string;
    required?: boolean;
